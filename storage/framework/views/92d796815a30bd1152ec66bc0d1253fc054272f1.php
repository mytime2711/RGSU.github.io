...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('article.index')); ?>" class="nav-link <?php if($route_prefix == 'article'): ?> active <?php endif; ?>">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH /Users/rithy/Documents/teaching/sunrise/tri3/news/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>